...
csvfile = open('32_EDUCACIÓN COMUNITARIA RURAL PRIMARIA_19-04-2018.txt', 'rb')
...
#print field_names[3]
#print table.next()[3]
info_general = ['CV_CCT', 'NOMBRECT', 'TIPO', 'NIVEL', 'SUBNIVEL', 'CV_CARACTERIZAN1', 'C_CARACTERIZAN1', 'CV_CARACTERIZAN2','C_CARACTERIZAN2', 'PERIODO', 'ZONA', 'JEFSEC', 'SERVREG', 'CV_ESTATUS_CAPTURA']
